...
import { previewPersistencePatch, type GeneratedLocatorCandidate } from 'ai-healing-sdk';
import { resolveLocatorTarget } from './locator-resolver';
import { snapshotToCandidate, toHealingSnapshot } from './locator-types';
...
export function writePersistenceProposal(
  ...
  fs.writeFileSync(
    ...
    [
      ...
      '',
      '```typescript',
      'import { applyMaintenanceProposal } from "autonomous-qa-sdk";',
