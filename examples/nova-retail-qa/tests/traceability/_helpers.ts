...
import { attachHealingSummary } from 'ai-healing-sdk';
import type { HealingResult, LocatorStrategy } from 'ai-healing-sdk';
import { clickHealing, expectVisibleHealing, fillHealing } from 'ai-healing-sdk';
