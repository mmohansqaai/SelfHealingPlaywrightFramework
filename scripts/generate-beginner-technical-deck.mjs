 ...
 * Run: node scripts/generate-beginner-technical-deck.mjs
 * Output: docs/Self-Healing-Framework-Beginner-Technical-Deck.pptx
 */
...
const outPath = join(__dirname, '..', 'docs', 'Self-Healing-Framework-Beginner-Technical-Deck.pptx');
...
async function main() {
  ...
  pptx.title = 'Self-Healing Playwright — Beginner Technical Guide';
  pptx.layout = 'LAYOUT_WIDE';

  titleSlide(
    pptx,
    'Self-Healing Playwright Framework\nTechnical guide for beginners',
    'Learn the ideas from zero: tests, locators, and resilient selectors'
  );
